...
// TODO(owner): once a screening vendor (CRA) is chosen, replace the last
// sentence of FCRA_DISCLOSURE with the agency's name, address, phone, and
// website (required for California applicants) — here AND in pdfGenerator.js.
const FCRA_DISCLOSURE =
  "Forbes Logistix LLC (“Forbes Logistix”) may obtain one or more consumer reports about you for employment purposes, including deciding whether to hire or engage you as a driver and, if you are hired or engaged, for decisions about your continued employment or engagement to the extent permitted by law. The reports may include information about your criminal record history, your driving and motor vehicle records, and verification of your prior employment. The reports will be obtained through a consumer reporting agency. You may request the agency’s name, address, telephone number, and website from Forbes Logistix at any time by calling (601) 300-5529.";
