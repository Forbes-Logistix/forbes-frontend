...
const sections = [
  ...
  },
  {
    ...
    icon: <FiHome />,
    body:
      "Our lanes are built so company drivers can be home most weekends. We do not sell you 'flexible scheduling' — we plan dispatch around real home time.",
  },
  {
...
export default function OperationsClient() {
  return (
    <div
      ...
      style={{ backgroundImage: `url(/assets/operationsBg.jpg)` }}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {sections.map((section, idx) => (
            ...
            >
              ...
              <div>
                <h2 className="text-xl md:text-2xl font-bold tracking-tight mb-2">{section.title}</h2>
